class Order < ActiveRecord::Base
  attr_accessible :action, :amount, :response, :card_number, :card_verification, :cart_id, :ip_address, :first_name, :last_name, :card_type, :card_expires_on, :express_token, :express_payer_id
